    ...
    <div class="col-12">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <button class="btn btn-success" data-toggle="modal" data-target="#modal">Add Category</button>
            </div>
        </div>
    </div>
    <div class="col-md-12">
                    ...
                    <table class="table table-bordered table-striped table-hover text-center mb-0" id="datatable1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td> {{ $ser }} </td>
                                <td>{{ $cat->cat }}</td>
                                <td><button onclick="edit_cat({{ $cat->id }}, '{{ $cat->cat }}')" class="btn btn-primary">Edit</button></< /td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
